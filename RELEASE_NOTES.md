...
## Version 2.2.7 - 2025-12-12

### 🚀 Major Parser & Grammar Update
- Pyparsing tabanlı grammar tamamen modüler ve kapsamlı hale getirildi. State machine ve indentation takibi güçlendirildi, blok geçişleri netleştirildi.
- Triple-quoted string ve monolog bölme mantığı SDK benzeri şekilde paragraf-paragraf ayrıldı.
- Menü, python, screen, label blokları için ayrı parse kuralları tanımlandı.
- Placeholder ve stil etiketleri atomik olarak korunup restore ediliyor.
- Satır devamı ve logical line birleştirme desteği eklendi.
- Teknik satırlar (image, define, default, transform vb.) tamamen hariç tutuluyor.
- Tüm testler ve araçlar bu yeni grammar ile uyumlu şekilde güncellendi.
- PyInstaller spec dosyasına pyparsing bağımlılığı eklendi.
