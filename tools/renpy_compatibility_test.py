...
def test_renpy_compatibility():
    ...
    for format_type in formats:
        ...
        content_lines = []
        content_lines.append(f"# Test translation file - {format_type} format")
        content_lines.append("# Generated by RenLocalizer-V2")
        content_lines.append("")
        
        for trans in test_translations:
            block = formatter.generate_translation_block(
                trans["original"],
                trans["translated"], 
                "tr",
                trans["id"],
