...
class InfoDialog(QDialog):
    ...
    def init_ui(self):
        ...
        if isinstance(dialog_data, str):
            ...
            self.setWindowTitle(self.config_manager.get_ui_text("dialog_info_title", "Info"))
    ...
    def create_simple_dialog(self):
        ...
        text.setHtml(f"<h3>{self.config_manager.get_ui_text('dialog_info_title', 'Info')}</h3><p>{self.config_manager.get_ui_text('dialog_info_loading', 'Information dialog is loading...')}</p>")
